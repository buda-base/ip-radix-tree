...
public class RadixTreeIpv4Test {
    ...
    public void testRealistic() throws IOException {
        IPv4RadixIntTree tr = IPv4RadixIntTree.loadFromLocalFile("data/ipv4/ip-prefix-base.txt");
        BufferedReader br = new BufferedReader(new FileReader("data/ipv4/test-1.txt"));
        String l;
        int n = 0;
    ...
    public void testNginx() throws IOException {
        IPv4RadixIntTree tr = IPv4RadixIntTree.loadFromLocalFile("data/ipv4/ip-prefix-nginx.txt", true);
        BufferedReader br = new BufferedReader(new FileReader("data/ipv4/test-nginx.txt"));
        String l;
        int n = 0;
        while ((l = br.readLine()) != null) {
            String[] c = l.split("\\s+", -1);
