 ...
 * https://github.com/spring-projects/spring-security/blob/master/web/src/test/java/org/springframework/security/web/util/matcher/IpAddressMatcherTests.java
 * @author Luke Taylor
 * @since 3.0.2
 */
